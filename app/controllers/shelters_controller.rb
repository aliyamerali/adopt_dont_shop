class SheltersController < ApplicationController
  ...
  def admin_index
    ...
    @shelters_with_pending = Shelter.with_pending_apps_alpha
  end
  ...
  def admin_show
    @shelter = Shelter.find_by_sql("SELECT name, street_address, city, state, zip_code FROM shelters WHERE id = #{params[:id]}")
    ...
    @pets_with_pending = Shelter.pets_with_pending(params[:id])
  end
